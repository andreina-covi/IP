...
% \begin{darkframes}
    ...
    \begin{frame}{Canal de comunicación y plataforma de trabajo}
        \begin{itemize}
            ...
            \raisebox{-0.35\height}{\includegraphics[height=1.1em]{resources/canvas.png}}
            ...
            \raisebox{-0.35\height}{\includegraphics[height=1.1em]{resources/clearn_full.png}}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Material de clases}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.5\linewidth]{resources/qr_intro.png}
        \end{figure}
    \end{frame}
